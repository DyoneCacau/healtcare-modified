-- ============================================================
-- SCRIPT: Receituário (tipo em clinic_documents) + Evoluções
-- Execute no Supabase: SQL Editor > New Query > Cole e Execute
--
-- O que este script faz:
-- 1) Inclui o tipo 'receituario' no CHECK de clinic_documents
-- 2) Cria a tabela patient_evolutions (histórico clínico datado)
-- 3) RLS para membros da clínica + superadmin
--
-- NÃO sobe automaticamente com o frontend (Vercel).
-- Rode este SQL no painel do Supabase antes de usar Evoluções em produção.
-- ============================================================

-- 1) Tipo receituario em clinic_documents
